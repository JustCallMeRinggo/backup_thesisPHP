...
=======
           <li><a href="admin_undergraduate.php"><i class="fa fa-graduation-cap"></i> Undergraduate</a></li>
            <li><a href="admin_masteral.php"><i class="fa fa-industry"></i> Masteral</a></li>
            <li><a href="admin_doctorate.php"><i class="fa fa-institution"></i> Doctorate</a></li>
          </ul>
                ...
                <div class="box-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>User Type</td>
                            <td>
                              <select name="add_ddlUserType" class="form-control">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <table class="table table-bordered" style="width:100%;">
              ...
              <?php
                $queryAdmins = "SELECT * FROM tblUsers WHERE user_type LIKE('%admin%')";
