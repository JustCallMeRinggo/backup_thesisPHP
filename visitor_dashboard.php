...
<head>
  ...
  <title>Thesys | Dashboard (Visitor)</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       <li class="active"><a href="visitor_dashboard.php"><i class="fa fa-th"></i> <span>Dashboard</span></a></li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="visitor_undergraduate.php"><i class="fa fa-graduation-cap"></i> Undergraduate</a></li>
            <li><a href="visitor_masteral.php"><i class="fa fa-industry"></i> Masteral</a></li>
            <li><a href="visitor_doctorate.php"><i class="fa fa-institution"></i> Doctorate</a></li>
          </ul>
