      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
           <li><a href="student_undergraduate.php"><i class="fa fa-graduation-cap"></i> Undergraduate</a></li>
            <li><a href="student_masteral.php"><i class="fa fa-industry"></i> Masteral</a></li>
            <li><a href="student_doctorate.php"><i class="fa fa-institution"></i> Doctorate</a></li>
          </ul>
